...
@jax.jit
def jitter_image(key: jax.Array, img: chex.Array) -> chex.Array:
...
@jax.jit
def crop_and_resize(key: jax.Array, x: chex.Array) -> chex.Array:
...
@jax.vmap
@jax.jit
def augment_image(key: jax.Array, x: chex.Array) -> chex.Array:
    """
    """
